resource "aws_s3_bucket" "sns" {
  bucket = "516-sns-bucket-${random_integer.this.result}-green"
}
...
resource "aws_s3_bucket" "sqs" {
  bucket = "516-sqs-bucket-${random_integer.this.result}-green"
}
...
resource "aws_s3_bucket" "lambda" {
  bucket = "516-lambda-bucket-${random_integer.this.result}-green"
}
