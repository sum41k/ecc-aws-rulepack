...
resource "aws_s3_bucket" "this" {
  bucket        = "097-bucket-${random_integer.this.result}-green"
  force_destroy = true
}
...
data "aws_iam_policy_document" "this" {
  ...
  statement {
    ...
    condition {
      ...
      values = [
        "arn:aws:cloudtrail:${var.default-region}:${data.aws_caller_identity.this.account_id}:trail/cloudtrail-097-green"
      ]
    }
  }
}
