resource "aws_codedeploy_app" "this" {
  ...
  name             = "484_codedeploy-app_red"
}

resource "aws_codedeploy_deployment_config" "this" {
  deployment_config_name = "484_deployment-config_red"
  compute_platform       = "Lambda"
...
resource "aws_codedeploy_deployment_group" "this" {
  ...
  deployment_group_name  = "484_codedeploy_deployment_group_red"
  ...
  alarm_configuration {
    alarms  = ["484_alarm1_red", "484_alarm2_red"]
    enabled = true
  }
