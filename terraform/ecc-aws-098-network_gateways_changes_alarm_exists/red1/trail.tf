...
resource "aws_s3_bucket" "this" {
  bucket        = "098-bucket-${random_integer.this.result}-red1"
  force_destroy = true
}
...
data "aws_iam_policy_document" "this" {
  ...
  statement {
    ...
    condition {
      ...
      values = [
        "arn:aws:cloudtrail:${var.default-region}:${data.aws_caller_identity.this.account_id}:trail/cloudtrail-098-red1"
      ]
    }
  }
}
