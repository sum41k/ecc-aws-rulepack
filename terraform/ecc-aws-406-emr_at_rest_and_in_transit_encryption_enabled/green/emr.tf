resource "aws_emr_cluster" "this" {
  ...
  master_instance_group {
    name           = "406_master_instance_group_green"
    instance_type  = "m4.large"
    instance_count = 1
  }

  core_instance_group {
    name           = "406_core_instance_group_green"
    instance_count = 1
    instance_type  = "m4.large"
  }
...
resource "aws_emr_security_configuration" "this" {
  name = "406_security_configuration_green"
  configuration = <<EOF
{
  "EncryptionConfiguration": {
    ...
    "InTransitEncryptionConfiguration" : {
      "TLSCertificateConfiguration" : {
        ...
        "S3Object" : "s3://406-bucket-green/my-certs.zip"
      }
    }
  }
}
...
resource "aws_kms_key" "this" {
  description             = "406_kms_key_green"
  deletion_window_in_days = 7
}

resource "aws_kms_alias" "this" {
  name          = "alias/406_kms_key_green"
