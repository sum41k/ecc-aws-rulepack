resource "aws_emr_cluster" "this" {
  ...
  master_instance_group {
    name           = "258_master_instance_group_red1"
    instance_type  = "m4.large"
    instance_count = 1
  }

  core_instance_group {
    name           = "258_core_instance_group_red1"
    instance_count = 1
    instance_type  = "m4.large"
  }
...
resource "aws_emr_security_configuration" "this" {
  name = "258_security_configuration_red1"
  configuration = <<EOF
{
