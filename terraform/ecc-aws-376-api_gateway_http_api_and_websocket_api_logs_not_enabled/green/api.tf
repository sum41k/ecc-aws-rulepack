...
resource "aws_cloudwatch_log_group" "this1" {
  name              = "376_log_group_green1"
  retention_in_days = 7
}

resource "aws_apigatewayv2_api" "this2" {
  name                       = "376_websocket_green"
...
resource "aws_apigatewayv2_stage" "this2" {
  ...
  name   = "376_websocket_api_stage_green"
